...
unsigned int last = 4;
String gripNames[] = {"", "\x10 Open", "\x10 Power", "\x10 Pinch", "\x10 Tripod", "\x10 Index", "\x10 Key", "\x10 Set Primary",""};
String gripNamesPrimary[] = {"", "\x10 Open", "\x10 Power", "\x10 Pinch", "\x10 Tripod", "\x10 Index", "\x10 Key", "\x10 Primary", "\x10 Reset"};
